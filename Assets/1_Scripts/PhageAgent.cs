...
public class PhageAgent : MonoBehaviour
{
    ...
    private Hittable _hittableScript;
    ...
    private void Start()
    {
        ...
        _hittableScript = GetComponent<Hittable>();
    ...
    {
        _betweenAttacksTimer = timeBetweenAttacksMultiplier.Evaluate(_hittableScript.GetLostHealthPercentage()) * timeBetweenAttacks;
        _phageState = PhageState.Moving;
    }
    ...
    private IEnumerator ExplosiveMinions()
    {
        ...
        var amountOfMinions = (int)explosiveMinionsAmount.Evaluate(_hittableScript.GetLostHealthPercentage());
    ...
    private IEnumerator AcidShot()
    {
        ...
        var amountShots = (int)acidShotAmount.Evaluate(_hittableScript.GetLostHealthPercentage() / 100);
